...
[Zesky Cli](https://www.npmjs.com/package/zesky-cli) is an interactive command line tool for Javascript (specially for Typescript) Environment developer. It's a project setup tool. It will reduce your initial project setup complexity and save the valuable times for you.
