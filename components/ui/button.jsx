	...
	'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-neutral-300',
	{
		variants: {
			variant: {
				...
				'gradient-fill':
					'bg-gradient-to-r from-green-500 to-yellow-300 text-black hover:bg-gradient-to-r hover:from-yellow-300 hover:to-green-500 font-medium py-2 px-4 rounded-full transition-all duration-500 ease-in-out bg-[length:200%_200%] hover:bg-[length:300%_300%] bg-left hover:bg-right',
			},
			size: {
